function togglePopup(id) {
    ...
    switch (id) {
        ...
        case "SW":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: 5 - 15 members</li> <li>Registration Fee: 500/-</li> <li>Finals: 22nd December 2022</li> <li>Venue: COEP Technological University</li> <li>Styles permitted: All styles except Classical and Street dance forms</li> </ul>";
        ...
        case "NG":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Registration Fee: 100/-</li> <li>Date: 22nd & 23rd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
            EveStructure.innerHTML = "<h2>Structure:</h2>" + "<br/>" + "<br/>" + "<h4>Eliminations:</h4>" + "<ul> <li>The contestants will be given 120 seconds to perform in front of the judges.</li> <li>The selected participants will move to the next round.</li> <li>TParticipants can bring one accompanist with them.</li> </ul>" + "<h4>Finals:</h4>" + "<ul> <li>Participants shortlisted have to perform an extended version of their eliminations performance or a new one all together.</li> <li>Time Limit: 3-5 minutes including setup time</li> </ul>";
            EveRules.innerHTML = "<h2>Rules:</h2>" + "<br/>" + "<br/>" + "<ul>  <li>This competition is open for college students of age group 16-25.</li> <li>All types of classical dances are allowed, however different dance forms will not be judged separately.</li> <li>Folk and semi-classical dances are not permitted.</li> <li>Vulgarity and obscenity at any point are strictly not allowed.</li> <li>Props (except hazardous and dangerous materials) are allowed. List of all the props should be given 7 days prior to the fest. Only the props mentioned in the list are allowed.</li> <li>Participants can have one accompanist supporting their performance with live music. Only the registered participant is eligible for the prize.</li> <li>The music track should be submitted to the Event Head two days prior to the event. Also, the participants are requested to bring their tracks in a pen drive at the Impressions venue.</li></ul>";
        ...
        case "LL":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 100/-</li> <li>Language: English / Hindi / Marathi</li> <li>Date: 24th December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
        ...
        case "SS":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: 8 - 20 (Including all music accompanists)</li> <li>Entry Fees: INR 800/-</li> <li>Language: English / Hindi / Marathi</li> <li>Time Duration: 7 - 10 minutes, including setup time.</li> <li>Date: 22nd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
        ...
        case "GOS":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry fees: INR 100/-</li> <li>Time Duration: 2.5 hours</li> <li>Date: 22nd - 24th December 2022 (specific date will be informed)</li> <li>Venue: COEP Technological University</li> </ul>";
            EveStructure.innerHTML = "<h2>Structure:</h2>" + "<br/>" + "<br/>" + "<ul>  <li>Themes will be disclosed at the time of the competition.</li> <li>Participants have to bring their own material- the necessary art supplies and a drawing board.</li> <li>Participants will be provided with a single A3 sheet.</li> <li>Participants have to complete their artwork in the above-mentioned time duration.</li> </ul>";
        ...
        case "PN":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo (+1 beatboxer can accompany)</li> <li>Registration Fee: INR 100/-</li> <li>Date: 23rd December 2022</li> <li>Venue:COEP Technological University</li> </ul>";
        ...
        case "AEB":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 100/-</li> <li>Language: Hindi / Urdu / Marathi</li> <li>Dates: 23rd December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
        ...
        case "KK":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 100/-</li> <li>Language: English / Hindi / Marathi</li> <li>Finals: 24th December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
        ...
        case "VA":
            ...
            EveDetails.innerHTML = "<h2>Details:</h2>" + "<br/>" + "<br/>" + "<ul> <li>Team Size: Solo</li> <li>Entry Fees: INR 100/-</li> <li>Language: English / Hindi / Marathi</li> <li>22nd & 23th December 2022</li> <li>Venue: COEP Technological University</li> </ul>";
